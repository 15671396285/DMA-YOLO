...
from ultralytics.nn.modules.CoreV8.Impove.MAF import Stem,ConvWrapper,AVG_down, CSPDepthResELAN, MPRep, SimConvWrapper, CSPRepResELAN, RepELANMSv2, CSPSDepthResELAN, SDepthMP, RepHDW, RepELANMS,RepELANMS2
...
class RTDETRDetectionModel(DetectionModel):
    ...
    def init_criterion(self):
        ...
        return RTDETRDetectionLoss(nc=self.nc, use_vfl=False) #11/26改动
...
def torch_safe_load(weight):
    ...
    try:
        with temporary_modules(
            modules={
                "ultralyticsPro1020.yolo.utils": "ultralyticsPro1020.utils",
                "ultralyticsPro1020.yolo.v8": "ultralyticsPro1020.models.yolo",
                "ultralyticsPro1020.yolo.data": "ultralyticsPro1020.data",
            },
            attributes={
                "ultralyticsPro1020.nn.modules.block.Silence": "torch.nn.Identity",  # YOLOv9e
                "ultralyticsPro1020.nn.tasks.YOLOv10DetectionModel": "ultralyticsPro1020.nn.tasks.DetectionModel",  # YOLOv10
            },
        ):
        ...
        if e.name == "models":
            raise TypeError(
                emojis(
                    ...
                    f"\nRecommend fixes are to train a new model using the latest 'ultralyticsPro1020' package or to "
