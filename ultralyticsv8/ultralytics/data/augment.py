    ...
    def __call__(self, labels):
        ...
        Args:
            labels (Dict): A dictionary containing the following keys:
                ...
                'instances' (ultralyticsPro1020.utils.instance.Instances): An object containing bounding boxes and
                    optionally keypoints.

        Returns:
            (Dict): The same dictionary with the flipped image and updated instances:
                'img' (numpy.ndarray): The flipped image.
                'instances' (ultralyticsPro1020.utils.instance.Instances): Updated instances matching the flipped image.
    ...
    def __call__(self, labels):
        ...
        Args:
            labels (Dict): A dictionary containing:
                ...
                - 'instances' (ultralyticsPro1020.engine.results.Instances): Object containing bounding boxes, segments, etc.
...
def classify_transforms(
    ...
    """
    import torchvision.transforms as T  # scope for faster 'import ultralyticsPro1020'
