...
class Model(nn.Module):
    ...
    def __call__(
        ...
        **kwargs,
        ...
        Returns:
            (List[ultralyticsPro1020.engine.results.Results]): A list of prediction results, each encapsulated in a
                Results object.
    ...
    def save(self, filename: Union[str, Path] = "saved_model.pt", use_dill=True) -> None:
        ...
        from ultralyticsPro1020 import __version__
    ...
    def predict(
        ...
        **kwargs,
        ...
        is_cli = (ARGV[0].endswith("yolo") or ARGV[0].endswith("ultralyticsPro1020")) and any(
    ...
    def track(
        ...
        **kwargs,
        ...
        Returns:
            (List[ultralyticsPro1020.engine.results.Results]): A list of tracking results, each a Results object.
    ...
    def val(
        ...
        **kwargs,
        ...
        Args:
            validator (ultralyticsPro1020.engine.validator.BaseValidator | None): An instance of a custom validator class for
                validating the model.
            **kwargs (Any): Arbitrary keyword arguments for customizing the validation process.

        Returns:
            (ultralyticsPro1020.utils.metrics.DetMetrics): Validation metrics obtained from the validation process.
    ...
    def benchmark(
        ...
        **kwargs,
        ...
        It uses the 'benchmark' function from the ultralyticsPro1020.utils.benchmarks module. The benchmarking is
    ...
    def tune(
        ...
        **kwargs,
        ...
        When Ray Tune is enabled, it leverages the 'run_ray_tune' function from the ultralyticsPro1020.utils.tuner module.
    ...
    def names(self) -> list:
        ...
        using the 'check_class_names' function from the ultralyticsPro1020.nn.autobackend module. If the predictor is not
