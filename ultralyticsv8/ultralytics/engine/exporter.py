...
Requirements:
    $ pip install "ultralyticsPro1020[export]"
...
def export_formats():
    ...
    import pandas  # scope for faster 'import ultralyticsPro1020'
...
class Exporter:
    ...
    def __call__(self, model=None) -> str:
        ...
        if edgetpu:
            ...
            elif self.args.batch != 1:  # see github.com/ultralyticsPro1020/ultralyticsPro1020/pull/13420
    ...
    def export_engine(self, prefix=colorstr("TensorRT:")):
        ...
        if int8:
            ...
            class EngineCalibrator(trt.IInt8Calibrator):
                def __init__(
                    self,
                    dataset,  # ultralyticsPro1020.data.build.InfiniteDataLoader
                    batch: int,
                    cache: str = "",
                ) -> None:
