...
def inference(model=None):
    ...
    check_requirements("streamlit>=1.29.0")  # scope imports for faster ultralyticsPro1020 package load speeds
    ...
    # Add ultralyticsPro1020 logo in sidebar
    with st.sidebar:
    ...
    if source == "video":
        ...
        if vid_file is not None:
            ...
            vid_location = "ultralyticsPro1020.mp4"
            with open(vid_location, "wb") as out:  # Open temporary file as bytes
                out.write(g.read())  # Read bytes into file
            vid_file_name = "ultralyticsPro1020.mp4"
    elif source == "webcam":
        vid_file_name = 0
