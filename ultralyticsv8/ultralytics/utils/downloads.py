...
GITHUB_ASSETS_REPO = "ultralyticsPro1020/assets"
GITHUB_ASSETS_NAMES = (
...
def get_github_assets(repo="ultralyticsPro1020/assets", version="latest", retry=False):
    """
    Retrieve the specified version's tag and assets from a GitHub repository. If the version is not specified, the
    function fetches the latest release assets.

    Args:
        repo (str, optional): The GitHub repository in the format 'owner/repo'. Defaults to 'ultralyticsPro1020/assets'.
    ...
    Example:
        ```python
        tag, assets = get_github_assets(repo='ultralyticsPro1020/assets', version='latest')
        ```
    """
...
def attempt_download_asset(file, repo="ultralyticsPro1020/assets", release="v8.2.0", **kwargs):
    """
    ...
    Example:
        ```python
        file_path = attempt_download_asset('yolov8n.pt', repo='ultralyticsPro1020/assets', release='latest')
        ```
    """
