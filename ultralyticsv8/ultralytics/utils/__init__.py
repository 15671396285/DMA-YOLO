...
LOGGING_NAME = "ultralyticsPro1020"
...
HELP_MSG = """
    ...
    1. Install the ultralyticsPro1020 package:
...
class IterableSimpleNamespace(SimpleNamespace):
    ...
    def __getattr__(self, attr):
        ...
        raise AttributeError(
            f"""
            '{name}' object has no attribute '{attr}'. This may be caused by a modified or out of date ultralyticsPro1020
            'default.yaml' file.\nPlease update your code with 'pip install -U ultralyticsPro1020' and if necessary replace
        ...
        with torch_distributed_zero_first(RANK):
            ...
            if not (correct_keys and correct_types and correct_version):
                LOGGER.warning(
                    ...
                    f"with your settings or a recent ultralyticsPro1020 package update. {self.help_msg}"
                )
                self.reset()
