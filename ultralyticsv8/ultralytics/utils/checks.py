...
def parse_requirements(file_path=ROOT.parent / "requirements.txt", package=""):
    ...
    Args:
        ...
        package (str, optional): Python package to use instead of requirements.txt file, i.e. package='ultralyticsPro1020'.
    ...
    Example:
        ...
        parse_requirements(package='ultralyticsPro1020')
        ```
    """
...
def check_version(
    ...
    if not current:  # if current is '' or None
        ...
        return True
    elif not current[0].isdigit():  # current is package name rather than version string, i.e. current='ultralyticsPro1020'
        try:
...
def check_latest_pypi_version(package_name="ultralyticsPro1020"):
    """
...
def check_pip_update_available():
    """
    Checks if a new version of the ultralyticsPro1020 package is available on PyPI.
        ...
        with contextlib.suppress(Exception):
            ...
            if check_version(__version__, f"<{latest}"):  # check if current version is < latest version
                LOGGER.info(
                    ...
                    f"Update with 'pip install -U ultralyticsPro1020'"
                )
                return True
    return False
...
def check_requirements(requirements=ROOT.parent / "requirements.txt", exclude=(), install=True, cmds=""):
    ...
    Example:
        ...
        check_requirements('ultralyticsPro1020>=8.0.0')

        # Check multiple packages
        check_requirements(['numpy', 'ultralyticsPro1020>=8.0.0'])
        ```
    """
...
def collect_system_info():
    ...
    for r in parse_requirements(package="ultralyticsPro1020"):
        try:
